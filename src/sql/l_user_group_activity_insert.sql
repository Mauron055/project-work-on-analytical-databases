--шаг 5
INSERT INTO STV2024050734__DWH.l_user_group_activity(hk_l_user_group_activity, hk_user_id, hk_group_id, load_dt, load_src)
...
where hash(hu.hk_user_id, hg.hk_group_id) not in (select hk_l_user_group_activity from STV2024050734__DWH.l_user_group_activity);